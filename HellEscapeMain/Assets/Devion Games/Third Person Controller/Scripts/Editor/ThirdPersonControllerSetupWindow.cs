...
namespace DevionGames
{
    public class ThirdPersonControllerSetupWindow : EditorWindow
    {
		...
		private PhysicsMaterial m_MaxFriction;
		private PhysicsMaterial m_Frictionless;
		...
		public static void ShowWindow()
		{
			...
			window.m_AnimatorController = AssetDatabase.LoadAssetAtPath<RuntimeAnimatorController>("Assets/Devion Games/Third Person Controller/Example/Animator Controllers/Third Person Controller.controller");
			window.m_MaxFriction = AssetDatabase.LoadAssetAtPath<PhysicsMaterial>("Assets/Devion Games/Third Person Controller/Example/Materials/MaxFriction.physicMaterial");
			window.m_Frictionless = AssetDatabase.LoadAssetAtPath<PhysicsMaterial>("Assets/Devion Games/Third Person Controller/Example/Materials/Frictionless.physicMaterial");
		}
        ...
        private void OnGUI()
        {
			...
			m_AnimatorController= (RuntimeAnimatorController)EditorGUILayout.ObjectField("Animator Controller", m_AnimatorController, typeof(AnimatorController), false);
